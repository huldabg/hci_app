group number 2: Muhammed Gelgör and Hulda Bergh Gabrielsen


email your README document to hci_lab@ails.ece.ntua.gr or gsiolas@mail.ntua.gr

The final delivery consists of 
1. The application files 
 zip file of the application 
 release apk 
...
Google API services) that your application requires. Also any links to the apk, repos,
etc.

in the project standard flutter values ​​are used:
Minimum SDK: API level 21 (Android 5.0)
Target SDK: API level 34 (Android 14)
Compile SDK: API level 34

System Image:
The application requires an Android emulator image with Google APIs. This is necessary because the QR-code scanner and camera integration rely on Google Play Services to function correctly in an emulated environment.
